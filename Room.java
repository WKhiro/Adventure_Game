...
public class Room {
  ...
  /**
   * @return String of all of the things in this room, one thing per line.
   */
  String whatStuff() {
  ...
  /**
   * Attempt to remove (and return) an thing from this room.
   ...
   * @return thing if this room cantains the named thing.or null otherwise. The thing is NOT removed from the room.
   */
   ...
   * @return true if this room cantains the named thing.
   */
